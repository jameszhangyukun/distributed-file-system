...
import com.dfs.common.utils.PrettyCodes;
import com.dfs.model.common.NettyPacketHeader;
...
public class NettyPacket {
    ...
    public static NettyPacket buildPacket(byte[] body, PacketType packetType) {
        ...
        builder.body = body;
        builder.header = new HashMap<>(PrettyCodes.trimListSize());
     ...
     * @param maxPackageSize 拆分包后每隔消息体的最大的数据了
     * @return 拆分消息集合
     */
    ...
    public void write(ByteBuf out) {
        NettyPacketHeader nettyPacketHeader = NettyPacketHeader
                .newBuilder()
    ...
    public static NettyPacket parsePacket(ByteBuf byteBuf) throws InvalidProtocolBufferException {
        ...
        return NettyPacket.builder().header(new HashMap<>(nettyPacketHeader.getHeadersMap()))
                .body(bodyBytes)
                .build();
    }
